...
从 asmr.one 自动采集同人音声，本地私有化存储，Web 端管理播放。当前状态：**Phase 8 代码完成，待真实交互验收**。
...
- 📊 **收听统计** — 基于 PlayLog 的播放次数 / 收听作品 / 总收听时长
- 🌙 **深色模式** — 一键切换明暗主题
- 🐳 **部署支持** — 启动批处理 + Docker 基础支持

## 当前限制

- DLsite 目前仅支持 RJ-only inspect / 元数据级能力，不支持真实下载
- Phase 8 还缺 4 条真实交互验收
- 字幕暂不支持翻译、双语显示、AI 生成
