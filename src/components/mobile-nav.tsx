...
const navItems = [
  ...
  { href: '/works', label: 'Library', icon: '♫' },
  { href: '/continue', label: 'Resume', icon: '▶' },
...
export default function MobileNav() {
  ...
  // Hide on login page (including ?error=...)
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="mt-0.5 h-0.5 w-4 rounded-full bg-zinc-900 dark:bg-zinc-100" />
              )}
            </Link>
          );
        })}
